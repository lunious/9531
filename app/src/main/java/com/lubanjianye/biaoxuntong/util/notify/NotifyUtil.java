package com.lubanjianye.biaoxuntong.util.notify;
...
/**
 * 项目名:   Lunioussky
 * 包名:     com.lubanjianye.biaoxuntong.util.notify
 * 文件名:   NotifyUtil
 * 创建者:   lunious
 * 创建时间: 2017/11/22  9:09
 * 描述:     TODO
 */
...
//                requestCode, intent, FLAG);
     ...
     * @param content
     */
    public void notify_biaoxuntong(PendingIntent pendingIntent, int smallIcon, int largeIcon,
                                   String ticker, String title, String content, boolean sound, boolean vibrate, boolean lights) {
