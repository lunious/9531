package com.lubanjianye.biaoxuntong.util.datapicker;
...
/**
 * 项目名:   LBBXT
 * 包名:     com.lubanjianye.biaoxuntong.util.datapicker
 * 文件名:   DatePickerView
 * 创建者:   lunious
 * 创建时间: 2017/12/15  18:33
 * 描述:     TODO
 */
...
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.main_theme_color));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Paint.Style.FILL);
        nPaint.setTextAlign(Paint.Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.main_theme_color));
    }
